...
class GalleriesControllerTest < ActionController::TestCase
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post :create, gallery: { cat_id: @gallery.cat_id, click_count: @gallery.click_count, count_pic: @gallery.count_pic, name: @gallery.name }
    end
  ...
  test "should update gallery" do
    patch :update, id: @gallery, gallery: { cat_id: @gallery.cat_id, click_count: @gallery.click_count, count_pic: @gallery.count_pic, name: @gallery.name }
    assert_redirected_to gallery_path(assigns(:gallery))
  end
