...
class PicsControllerTest < ActionController::TestCase
  ...
  test "should create pic" do
    assert_difference('Pic.count') do
      post :create, pic: { code: @pic.code, gallery_id: @pic.gallery_id, original_url: @pic.original_url, oss_url: @pic.oss_url, visit_count: @pic.visit_count }
    end
  ...
  test "should update pic" do
    patch :update, id: @pic, pic: { code: @pic.code, gallery_id: @pic.gallery_id, original_url: @pic.original_url, oss_url: @pic.oss_url, visit_count: @pic.visit_count }
    assert_redirected_to pic_path(assigns(:pic))
  end
